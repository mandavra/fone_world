        ...
        <div className="relative overflow-hidden min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] lg:min-h-screen">
          ...
          <div className="relative z-10 flex items-center h-full">
            <div className="w-full md:w-3/4 lg:w-1/2 px-6 sm:px-10 md:pl-16">
              ...
              <button className="bg-teal-700 border-2 border-white text-white px-5 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg md:text-xl font-semibold hover:bg-teal-600 transition-colors">
                Book an Appointment
              </button>
            </div>
          </div>
