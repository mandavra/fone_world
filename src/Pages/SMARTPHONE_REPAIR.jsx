      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-center">
          ...
          <div data-aos="fade-up">
            ...
            <p className="text-lg text-gray-900">
              We repair phones and tablets here at Fone World Hove as quickly as possible. If the tablet is faulty don’t hesitate to get in touch today.
            </p>
          </div>
          {/* Laptop Repair */}
          <div data-aos="fade-down">
            ...
            <p className="text-lg text-gray-900">
              Have a damaged laptop, you need it to be repaired or refurbished here at Fone world Hove we are here to fix it as soon as possible
            </p>
          </div>
          {/* Smartwatch Repair */}
          <div data-aos="fade-left">
            ...
            <p className="text-lg text-gray-900">
              Damaged smart watches need to be repaired. Here at Fone World Hove we offer you a repair or refurbished service for your smart watch.
            </p>
          </div>
        </div>
      </section>
