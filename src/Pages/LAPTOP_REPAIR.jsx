    ...
    <>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Laptop Repair Services at Fone World Hove</h2>
            <p className="text-lg mb-6">
              Damaged laptops can cause major disruption, but expert help is available at Fone World Hove. Known among trusted laptop repair shops in Hove, our team delivers fast, reliable repair solutions for all makes and models. We repair common issues such as <a href="#" className="text-sky-500 underline">broken screens</a>, unresponsive keyboards, and faulty batteries using top-quality parts.
            </p>
            <p className="text-lg mb-10">
              Our services are available to customers across Hove and those looking for a reputable Brighton laptop shop. Technicians at our store provide transparent diagnostics and explain the repair process clearly. If you need a quick fix or a full refurbishment, Fone World Hove ensures your laptop gets back in working condition with minimal downtime.
            </p>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        ...
        <AnimatedBlock direction="right" delayMs={200} className="flex-1 flex justify-center p-0">
          ...
          {/* Left Column */}
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Visit Fone World Hove for Expert Laptop Repairs</h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Efficient service, expert staff, and high-quality parts make Fone World Hove your go-to destination for all laptop issues. If you’re dealing with screen problems, keyboard faults, or battery failures, our technicians have the right tools and experience.</p>
              <p>Walk-ins are welcome, or you can contact us to book a diagnostic check. Located centrally, our store serves customers across Hove and nearby Brighton. Find out why we’re trusted by students, professionals, and families alike.</p>
              <p>Bring your device in today and discover why Fone World Hove stands out among local laptop repair shops in Hove. Fast fixes are just around the corner!</p>
            </div>
...
const FAQ = () => {
  ...
  const faqs = [
    {
      q: 'What laptop repair services does Fone World Hove offer?',
      a: 'Fone World Hove provides a full suite of laptop repair options—including screen/LCD replacement, keyboard repair, battery replacement, charging port repair—and diagnostic services for all makes and models, using high-quality parts and aiming for fast turnaround times.'
    },
    {
      q: 'Do you repair broken or flickering laptop screens?',
      a: 'Yes, specializing in laptop LCD replacement, Fone World Hove fixes cracked, flickering, or touchscreen‑affected displays, ensuring restored visuals and touchscreen functionality.'
    },
    {
      q: 'Can Fone World Hove fix laptops that wont charge or stay powered on?',
    ...
    },
    {
      ...
      a: 'Yes, Fone World Hove offers transparent in store diagnostics and strives for quick turnarounds. Many repairs are completed the same day, minimizing downtime.'
    },
    {
      q: 'Where is Fone World Hove located, and do they accept walk‑ins?',
      a: 'Located at 48 George St, Hove BN3 3YB, Fone World Hove welcomes walk‑ins and scheduled diagnostic appointments. They serve customers across Hove and Brighton with convenient local acce.'
    }
  ]
