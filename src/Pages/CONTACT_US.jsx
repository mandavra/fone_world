      ...
      <section className="py-20 bg-white" data-aos="fade-up" data-aos-delay="100" data-aos-duration="900">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-start gap-8">
            {/* Store Hours */}
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[220px] max-w-[240px]" data-aos="flip-left" data-aos-delay="100" data-aos-duration="700">
              ...
              <p className="text-sm text-gray-600 leading-relaxed group-hover:text-gray-800 transition-colors duration-500">Sun: 10:00 AM to 5:00 PM</p>
            </div>

            {/* WhatsApp Contact */}
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[220px] max-w-[240px]" data-aos="flip-left" data-aos-delay="200" data-aos-duration="700">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 ease-out">
              ...
              <h3 className="font-bold text-lg text-black mb-3 group-hover:text-red-600 transition-colors duration-500">07919933386</h3>
            ...
            {/* Phone Contact */}
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[220px] max-w-[240px]" data-aos="flip-left" data-aos-delay="300" data-aos-duration="700">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 ease-out">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Physical Address */}
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[220px] max-w-[240px]" data-aos="flip-left" data-aos-delay="400" data-aos-duration="700">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 ease-out">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-bold text-lg text-black mb-3 group-hover:text-red-600 transition-colors duration-500">48 George St, Hove, BN3 3YB</h3>
            </div>

            {/* Email Contact */}
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[220px] max-w-[240px]" data-aos="flip-left" data-aos-delay="500" data-aos-duration="700">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 ease-out">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="font-bold text-lg text-black mb-3 group-hover:text-red-600 transition-colors duration-500">haywards@gmail.com</h3>
      ...
      <section className="py-16 bg-gray-50" data-aos="fade-up" data-aos-delay="100" data-aos-duration="900">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div className="bg-white p-8 rounded-lg shadow-lg" data-aos="fade-right" data-aos-delay="150" data-aos-duration="800">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Whatsapp: 07919933386</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">haywards@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Phone Repair District</p>
