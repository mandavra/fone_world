          ...
          <div>
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Get trusted Samsung repair in Brighton from certified technicians at Fone
                World Hove. It doesn’t matter if you are dealing with cracked screens,
              ...
              <p className="mt-4 text-lg leading-8 text-gray-700">
                Our Brighton-based technicians deliver quick, precise Samsung repairs using
                ...
                choice for Samsung repair in Brighton.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 sm:px-8 md:pb-20 lg:pb-24">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                We provide the best Samsung screen repair in Brighton with
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Samsung battery repair in Brighton features high-quality batteries
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                No more cracked screens; our Samsung glass repair in Brighton is fast,
          ...
          <div className="grid items-center gap-10 md:grid-cols-3 lg:gap-14">
            ...
            <div className="md:col-span-1">
              ...
              <p className="mt-6 text-lg leading-8 text-white/90">
                We offer expert Samsung repairs in Hove and Brighton, backed by years of
                hands-on experience.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 text-center sm:px-8 md:py-20 lg:py-24">
          <div className="grid grid-cols-1 gap-16 md:grid-cols-3 md:gap-12">
            ...
            <div className="mx-auto max-w-xl" data-aos="fade-right">
              ...
              <h3 className="text-3xl font-extrabold sm:text-4xl">Brighton & Hove Repairs</h3>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="relative rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-100 flex flex-col h-full">
              ...
              <p className="mt-4 text-lg italic text-gray-800">Screen repaired in 30 minutes! Broke my Samsung and Fone World fixed it the same day. Super friendly staff.</p>
