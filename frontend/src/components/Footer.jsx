...
//                   try {
//                     const resp = await fetch("https://your-api-domain.com/api/subscribe", {
//                       method: "POST",
...
//                 <button
//                   type="submit"
//                   className="rounded-full bg-red-600 px-8 py-3 font-semibold text-white hover:bg-red-700 transition w-full sm:w-auto"
//                 >
//                   Subscribe
//                 </button>
//               </form>
...
//                 <p className="mb-4 text-xl font-semibold text-white">EXPLORE</p>
//                 <ul className="space-y-3">
//                   {["Home", "About Us", "Privacy Policy", "Terms and Conditions"].map((item) => (
//                     <li key={item} className="flex items-center gap-2 hover:text-white transition">
...
//               {/* Contact */}
//               <div className="animate-fade-in-up">
//                 <p className="mb-4 text-xl font-semibold text-white">CONTACT US</p>
...
//                   <li className="flex items-center gap-3">
//                     <span className="text-red-600">🟢</span>
//                     <a href="tel:+447919933386">+44 7919 933386</a>
//                   </li>
//                   <li className="flex items-center gap-3">
//                     <span className="text-red-600">✉️</span>
//                     <a href="mailto:drex.haywards@gmail.com">drex.haywards@gmail.com</a>
//                   </li>
//                   <li className="flex items-start gap-3">
//                     <span className="mt-0.5 text-red-600">📍</span>
//                     <span>17 South Road, Haywards Heath RH16 4LE</span>
//                   </li>
//                 </ul>
//               </div>
//             </div>
...
const Footer = () => {
  return (
    <footer className="bg-[#2b2e33] text-gray-300 pt-16 pb-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 border-t border-gray-700/60 pt-6 text-center text-sm text-gray-400">
          DR.EX © 2025 | All Rights Reserved.
        </div>
      </div>
    </footer>
  );
