...
const CONTACT_US = () => {
  ...
  const API_BASE = import.meta.env.VITE_API_BASE_URL || (window.location.hostname.includes('vercel.app') ? 'https://foneworld-backend.vercel.app');
  useEffect(() => {
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Whatsapp: +44 7919 933386</p>
                  </div>
                </div>
