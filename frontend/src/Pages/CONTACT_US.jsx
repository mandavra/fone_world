        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-start gap-8">
            ...
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[220px] max-w-[240px]" data-aos="flip-left" data-aos-delay="200" data-aos-duration="700">
              ...
              <h3 className="font-bold text-lg text-black mb-3 group-hover:text-red-600 transition-colors duration-500">44+7919933386</h3>
            ...
            {/* Email Contact */}
            <div className="group flex flex-col items-center text-center p-8 bg-white border border-gray-200 rounded-2xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 ease-out transform hover:border-red-300 min-w-[320px] max-w-[240px]" data-aos="flip-left" data-aos-delay="500" data-aos-duration="700">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 ease-out">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="font-bold text-lg text-black mb-3 group-hover:text-red-600 transition-colors duration-500">drex.drex.haywards@gmail.com</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Whatsapp: 44+7919933386</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">drex.drex.haywards@gmail.com</p>
                  </div>
                </div>
