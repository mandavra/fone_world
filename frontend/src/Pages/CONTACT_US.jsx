          ...
          <div className="flex flex-wrap justify-center items-start gap-8">
            ...
            >
              <div className="mb-6 flex flex-row items-center justify-center gap-4">
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-red-500 transition-all duration-500 ease-out group-hover:rotate-12 group-hover:scale-125">
              ...
              <h3 className="font-bold text-lg text-black mb-3 group-hover:text-red-600 transition-colors duration-500">+44 7919 933386</h3>
              <p className="text-sm text-gray-600 leading-relaxed group-hover:text-gray-800 transition-colors duration-500">We are available on Whatsapp and Call</p>
            </a>
            ...
            <div className="space-y-8" data-aos="fade-left" data-aos-delay="200" data-aos-duration="800">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-gray-600">Phone / Whatsapp: +44 7919 933386</p>
                  </div>
                </div>
