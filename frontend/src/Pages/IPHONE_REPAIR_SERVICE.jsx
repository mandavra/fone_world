          ...
          <div className="grid items-center gap-10 md:grid-cols-3 lg:gap-14">
            ...
            <div className="md:col-span-1">
              ...
              <p className="mt-6 text-lg leading-8 text-white/90">
                We offer expert iPhone repairs in Haywards Heath and Haywards Heath, backed by years of
                hands-on experience.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl grid items-center gap-12 px-6 py-16 sm:px-8 md:grid-cols-2 md:gap-16 md:py-20 lg:gap-24 lg:py-24">
          ...
          <div>
            ...
            <p className="mt-8 text-lg leading-8 text-gray-700">
              We’re known for our expert Apple iPhone screen repair in Haywards Heath. No
              ...
              in Haywards Heath with fast turnaround times. We work on all models, from older
