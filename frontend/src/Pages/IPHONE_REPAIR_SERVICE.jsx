          ...
          <div className="grid items-center gap-12 md:grid-cols-2 md:gap-14 lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Get trusted iPhone repair in Brighton from certified technicians at Fone
              ...
              <p className="mt-4 text-lg leading-8 text-gray-700">
                Our Brighton-based technicians deliver quick, precise iPhone repairs using
                ...
                choice for iPhone repair in Brighton.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 sm:px-8 md:pb-20 lg:pb-24">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                We provide the best iPhone screen repair in Brighton with
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                iPhone battery repair in Brighton features high-quality batteries
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                No more cracked screens; our iPhone glass repair in Brighton is fast,
          ...
          <div className="grid items-center gap-10 md:grid-cols-3 lg:gap-14">
            ...
            <div className="md:col-span-1">
              ...
              <p className="mt-6 text-lg leading-8 text-white/90">
                We offer expert iPhone repairs in Hove and Brighton, backed by years of
                hands-on experience.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl grid items-center gap-12 px-6 py-16 sm:px-8 md:grid-cols-2 md:gap-16 md:py-20 lg:gap-24 lg:py-24">
          ...
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-gray-700">
              ...
              durable and efficient iPhone screen repair in Brighton, we’re the trusted
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 text-center sm:px-8 md:py-20 lg:py-24">
          <div className="grid grid-cols-1 gap-16 md:grid-cols-3 md:gap-12">
            ...
            <div className="mx-auto max-w-xl">
              ...
              <h3 className="text-3xl font-extrabold sm:text-4xl">iPhone Repairs in Hove</h3>
              <p className="mt-4 text-lg leading-8">
                Get fast, reliable local iPhone repairs in Hove from technicians you can
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="relative rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-100 flex flex-col h-full">
              ...
              <p className="mt-4 text-lg italic text-gray-800">Screen repaired in 30 minutes! Broke my iPhone and Fone World fixed it the same day. Super friendly staff.</p>
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 my-12 px-2" data-aos="fade-left">
        ...
        <div className="flex-1 bg-[#ff0000] rounded-3xl flex flex-col md:flex-row items-center p-6 md:p-12 shadow-lg">
          ...
          <div className="flex-1 md:pl-12 text-center md:text-left">
            ...
            <p className="text-white text-lg mb-10">Visit our Brighton location or contact us online; booking your iPhone repair service has never been more convenient.</p>
