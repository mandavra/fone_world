...
const Samsung_REPAIR_SERVICE = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col-reverse items-center gap-12 py-20 md:flex-row md:justify-between md:py-28 lg:py-36">
            ...
            <div className="w-full max-w-3xl">
              <div className="mb-6 flex items-center text-lg text-gray-300/90">
                ...
                <span className="text-white/95">Samsung Repair Service</span>
              </div>
            ...
            <div className="w-full md:w-auto md:shrink-0">
              <img
                ...
                src="https://foneworld-hove.co.uk/wp-content/uploads/2025/08/Untitled_design__1_-removebg-preview.png"
                alt="Broken Samsung back glass"
                loading="eager"
              />
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 md:py-20 lg:py-24">
          ...
          <div>
              <img
                ...
                src="https://foneworld-hove.co.uk/wp-content/uploads/2025/08/Reliable-Screen-Battery-Repairs-1-1536x921.png"
            ...
            <div>
              <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-gray-900 sm:text-4xl">
                Fast, Reliable, and Affordable Samsung Repairs
              </h2>
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Get trusted Samsung repair in Haywards Heath from certified technicians at Dr.ex Haywards Heath
                World Haywards Heath. It doesn’t matter if you are dealing with cracked screens,
                battery replacements, charging issues, or glass repairs; we offer fast,
                reliable, and professional service for all Samsung models at competitive
                prices.
              </p>

              <h3 className="mt-10 text-2xl font-extrabold tracking-tight text-gray-900">
                Why Choose Us for Apple Samsung Repair?
              </h3>
              <p className="mt-4 text-lg leading-8 text-gray-700">
                Our Haywards Heath-based technicians deliver quick, precise Samsung repairs using
                ...
                glass issue, we aim to restore your device efficiently, making us a top
                  choice for Samsung repair in Haywards Heath.
              </p>
      ...
      {/* Section title: Our Most Popular Samsung Repair Services */}
      <section className="bg-white" data-aos="fade-right">
        <div className="mx-auto max-w-7xl px-6 py-12 text-center sm:px-8 md:py-14 lg:py-16">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl">
            Our Most Popular <span className="text-red-600">Samsung Repair Services</span>
          </h2>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 sm:px-8 md:pb-20 lg:pb-24">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                We provide the best Samsung screen repair in Haywards Heath with
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                Samsung battery repair in Haywards Heath features high-quality batteries
            ...
            <div className="rounded-2xl bg-white p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.06)] ring-1 ring-gray-100">
              <h3 className="text-2xl font-extrabold leading-snug text-red-600 sm:text-3xl">
                Samsung Glass Repair
                <br />
                Service
              </h3>
              <p className="mt-6 text-lg leading-8 text-gray-700">
                No more cracked screens; our Samsung glass repair in Haywards Heath is fast,
          ...
          <div className="grid items-center gap-10 md:grid-cols-3 lg:gap-14">
            ...
            <div className="md:col-span-1">
              ...
              <p className="mt-6 text-lg leading-8 text-white/90">
                  We offer expert Samsung repairs in Haywards Heath and Brighton, backed by years of
                hands-on experience.
              </p>
            </div>
      ...
      <section className="bg-white" data-aos="flip-left">
        <div className="mx-auto max-w-7xl grid items-center gap-12 px-6 py-16 sm:px-8 md:grid-cols-2 md:gap-16 md:py-20 lg:gap-24 lg:py-24">
          ...
          <div>
            ...
            Reliable Screen & Battery Repairs
            </h2>
            <p className="mt-8 text-lg leading-8 text-gray-700">
              It doesn’t matter if you have cracked displays, battery problems, or anything in between; we’re the trusted choice for Samsung mobile repair in Haywards Heath. Our technicians are skilled in diagnosing and fixing a wide range of issues across all Samsung models, including Galaxy S, Note, and A-series devices. Every phone is handled with expert care and attention to detail, using high-quality parts to preserve both performance and longevity. With a commitment to customer satisfaction, we’ve earned a reputation for delivering efficient repairs and dependable results. If you need a quick screen fix or a full battery replacement, we offer fast, reliable service that gets your device back in shape.
            </p>
          ...
          <div>
            <img
              className="w-full rounded-xl border border-gray-200 shadow-lg"
              src="https://foneworld-hove.co.uk/wp-content/uploads/2025/08/Reliable-Screen-Battery-Repairs-1-1536x921.png"
              alt="Technician repairing Samsung on workstation"
              loading="lazy"
            />
          </div>
        </div>
      ...
      <section className="bg-red-600 text-white" data-aos="fade-up-right">
        <div className="mx-auto max-w-7xl px-6 py-16 text-center sm:px-8 md:py-20 lg:py-24">
          <div className="grid grid-cols-1 gap-16 md:grid-cols-3 md:gap-12">
            {/* Item 1 */}
            <div className="mx-auto max-w-xl" data-aos="fade-right">
              ...
              <h3 className="text-3xl font-extrabold sm:text-4xl">Haywards Heath & Brighton Repairs</h3>
              <p className="mt-4 text-lg leading-8">
                Skilled repair service is done locally with trusted techniques and expert hands.
              </p>
            </div>
            ...
            <div className="mx-auto max-w-xl" data-aos="fade-up">
              ...
              <h3 className="text-3xl font-extrabold sm:text-4xl">Straightforward Pricing</h3>
              <p className="mt-4 text-lg leading-8">
                Know the cost before we begin; no hidden charges, just honest quotes.
              </p>
            </div>

            {/* Item 3 */}
            <div className="mx-auto max-w-xl" data-aos="fade-left">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="mx-auto mb-6 h-16 w-16" fill="none" stroke="currentColor" strokeWidth="1.8">
                <circle cx="12" cy="7" r="3.5" />
                <path d="M4 20a8 8 0 0116 0" />
              </svg>
              <h3 className="text-3xl font-extrabold sm:text-4xl">Certified Repair Team</h3>
              <p className="mt-4 text-lg leading-8">
                All technicians are qualified to handle Samsung devices and offer repairs under warranty.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl grid items-center gap-12 px-6 py-16 sm:px-8 md:grid-cols-2 md:gap-16 md:py-20 lg:gap-24 lg:py-24">
          ...
          <div>
            <img
              ...
              src="https://foneworld-hove.co.uk/wp-content/uploads/2025/08/Reliable-Screen-Battery-Repairs-3-1536x921.png"
          ...
          <div>
            ...
            <p className="mt-8 text-lg leading-8 text-gray-700">
            Your privacy is important to us. We never access your personal data at any stage of the repair. Every Samsung device is handled with care, following strict security procedures to keep your information safe from start to finish.
            </p>
            <div className="mt-10">
              <Link
                to="/contact-us"
      ...
      {/* Trusted by Samsung users CTA band */}
        ...
        <div className="mx-auto max-w-7xl items-center gap-8 px-6 py-12 sm:px-8 md:grid md:grid-cols-3 md:py-16 lg:py-20">
          ...
          <div className="col-span-1 text-center md:col-span-1">
            <h2 className="text-4xl font-extrabold leading-tight sm:text-5xl md:text-6xl drop-shadow-[0_2px_2px_rgba(0,0,0,0.35)]">
              Trusted by Samsung Users Across
              <br />
                Haywards Heath
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="relative rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-100 flex flex-col h-full">
              ...
              <p className="mt-4 text-lg italic text-gray-800">Screen repaired in 30 minutes! Broke my Samsung and Dr.ex Haywards Heath fixed it the same day. Super friendly staff.</p>
            ...
            <div className="relative rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-100 flex flex-col h-full">
              <span className="absolute right-8 top-8 text-red-600 text-5xl font-bold select-none">”</span>
              <p className="mt-4 text-lg italic text-gray-800">My Samsung battery wouldn’t last half a day. They replaced it quickly and now it’s like new. Highly recommend!</p>
              <div className="mt-8 flex items-center gap-3">
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 my-12 px-2" data-aos="fade-left">
        ...
        <div className="flex-1 bg-[#ff0000] rounded-3xl flex flex-col md:flex-row items-center p-6 md:p-12 shadow-lg">
          {/* Left: Samsung with no battery icon */}
          ...
          <div className="flex-1 md:pl-12 text-center md:text-left">
            ...
            <p className="text-white text-lg mb-10">Visit our Brighton location or contact us online; booking your Samsung repair service has never been more convenient.</p>
        ...
        {/* Book Online Card */}
        <div className="flex-1 bg-[#ff0000] rounded-3xl flex flex-col md:flex-row items-center p-6 md:p-12 shadow-lg">
          {/* Left: Samsung with cracked screen image */}
          <div className="flex-shrink-0 w-full md:w-1/3 flex justify-center mb-8 md:mb-0">
            <img
      ...
      {(() => {
        const faqs = [
          ...
          {
            q: 'How long does Samsung screen repair take?',
...
export default Samsung_REPAIR_SERVICE