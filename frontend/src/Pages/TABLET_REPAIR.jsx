        ...
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Tablet Repair Services at Dr.ex Haywards Heath</h2>
            <div className="text-lg space-y-4 mb-6">
              ...
              <p>Whether you’re in Brighton or Haywards Heath, our expert team is here to help with all kinds of tablet problems. We use quality parts and trusted repair methods to ensure your device works like new again. Visit us today for quick, affordable, and hassle-free tablet repairs.</p>
            </div>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        ...
        <AnimatedBlock direction="right" delayMs={200} className="flex-1 flex justify-center p-0">
          ...
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            ...
            <div className="text-lg space-y-4 mb-6">
              <p>Don’t let a damaged tablet slow you down. Visit Dr.ex Haywards Heath for expert tablet repair services in Haywards Heath and Brighton. If your device needs a screen replacement, battery replacement, or any other repair, our technicians are ready to get it back to full functionality.</p>
