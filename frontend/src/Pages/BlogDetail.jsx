              ...
              <div className="prose max-w-none">
                ...
                {blog.id === 2 && (
                  <>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      At FONE WORLD, we specialize in fast tablet screen repairs. Our experienced technicians can replace cracked screens quickly and efficiently, often completing repairs within the same day. We use high-quality replacement parts and provide warranties on all our work.
                    </p>
                  </>
                )}
