    ...
    <>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Expert Smartphone Repair Services in Hove and Brighton </h2>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            ...
            Looking for a reliable smartphone repairing shop in Hove and Brighton? Look no further! Fone World Hove is here to provide top-notch repair services, from complete smartphone repair in Hove to quick fixes. Our team is dedicated to getting your device back in perfect condition.
            <br></br>      <br></br>     <br></br>
