            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 animate-slide-in-left" data-aos="fade-right" data-aos-delay="150" data-aos-duration="900">
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  and the surrounding areas. With over six years of experience, our skilled
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  damaged? Not to worry, our technicians are here to help. If
                    ...
                    Dr.ex Haywards Heath has you covered with expert solutions.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  We repair phones and tablets here at Dr.ex Haywards Heath and the surrounding areas as
              ...
              >
               ...
               />
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  Dr.ex Haywards Heath and the surrounding areas, we fix laptops promptly and professionally.
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  and the surrounding areas, we offer repair and refurbishment services using
