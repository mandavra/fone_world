      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Smart Watch Repair in Haywards Heath & Brighton</h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Looking for reliable smart watch repair in Haywards Heath or Brighton? At Dr.ex Haywards Heath, we provide fast, professional, and affordable solutions to get your smartwatch back in top working condition. Whether your device has a cracked screen, battery issue, or connectivity fault, our experienced technicians are here to help.</p>
...
Our goal is to make sure you can continue using your smartwatch without interruptions, whether it’s for work, fitness, or staying connected.</p>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        ...
        <AnimatedBlock direction="right" delayMs={200} className="flex-1 flex justify-center p-0">
          ...
          {/* Left Column */}
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Brighton & Haywards Heath Smart Watch Repair Shop </h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Located conveniently in Haywards Heath, we proudly serve both Haywards Heath and Brighton residents. Customers trust us as their go-to Brighton smart watch repair shop thanks to our consistent quality and professional approach. From minor fixes to complex repairs, you can rely on us for dependable results.</p>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Get Your Smart Watch Repaired Today</h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Don’t let a broken smartwatch slow you down. Visit Dr.ex Haywards Heathfor trusted smart watch repair in Brighton and Haywards Heath. Our expert technicians are ready to provide quick, effective, and reliable repairs at a fair price.</p>
