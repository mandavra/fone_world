      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Smart Watch Repair in Haywards Heath & Haywards Heath</h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Looking for reliable smart watch repair in Haywards Heath or Haywards Heath? At Dr.ex Haywards Heath, we provide fast, professional, and affordable solutions to get your smartwatch back in top working condition. Whether your device has a cracked screen, battery issue, or connectivity fault, our experienced technicians are here to help.</p>
 ...
 <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        ...
        <AnimatedBlock direction="right" delayMs={200} className="flex-1 flex justify-center p-0">
          ...
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            ...
            <div className="text-lg space-y-4 mb-6">
              <p>Smartwatches have become an essential part of daily life, tracking fitness, receiving notifications, and keeping you connected on the go. When something goes wrong, it can be frustrating. That’s why our professional smart watch repair in Haywards Heath covers a wide range of issues, including:</p>
             <ul>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          {/* Left Column */}
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Why Choose Dr.ex Haywards Heathfor Smart Watch Repair?</h2><br></br>
            <div className="text-lg space-y-4 mb-6">
            <ul>
              <li>
...
Our goal is to make sure you can continue using your smartwatch without interruptions, whether it’s for work, fitness, or staying connected.</p>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        ...
        <AnimatedBlock direction="right" delayMs={200} className="flex-1 flex justify-center p-0">
          ...
          {/* Left Column */}
          <AnimatedBlock direction="left" delayMs={100} className="flex-1">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Haywards Heath & Haywards Heath Smart Watch Repair Shop </h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Located conveniently in Haywards Heath, we proudly serve both Haywards Heath and Haywards Heath residents. Customers trust us as their go-to Haywards Heath smart watch repair shop thanks to our consistent quality and professional approach. From minor fixes to complex repairs, you can rely on us for dependable results.</p>
              <p>If you’re also in need of a  <a href="home">phone repair service in Haywards Heath</a></p>
      ...
      <section className="w-full bg-white py-20 px-2 md:px-4 flex justify-center">
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10 pl-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Get Your Smart Watch Repaired Today</h2>
            <div className="text-lg space-y-4 mb-6">
              <p>Don’t let a broken smartwatch slow you down. Visit Dr.ex Haywards Heathfor trusted smart watch repair in Haywards Heath and Haywards Heath. Our expert technicians are ready to provide quick, effective, and reliable repairs at a fair price.</p>
      ...
      <section className="w-full bg-gray-50 py-24 px-4 animate-fadeIn" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
        <div className="max-w-5xl mx-auto">
          <div ref={faqHeaderRef} className={`transition-all duration-700 ease-out transform ${faqHeaderVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            ...
            <p className="text-center text-gray-600 mb-10">Answers to common questions about our smart watch repair services.</p>
          </div>
...
const FAQ = () => {
  const items = [
    ...
    { q: 'Are the parts used genuine quality?', a: 'Dr.ex Haywards Heath uses high‑quality OEM or equivalent components to ensure lasting repairs and reliable operation' },
    ...
    { q: 'What types of smartwatch repairs does Dr.ex Haywards Heath perform?', a: 'They offer a complete range of services including diagnostics, battery replacement, water‑damage assessment, charge-port fixes, and LCD/glass replacements for leading brands such as Apple, Samsung, and Huawei' },
